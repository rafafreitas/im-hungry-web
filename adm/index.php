        ...
        <div class="animated fadeIn">
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-sm-5">
                  <h4 class="card-title mb-0">Vendas - Por Filial</h4>
                  <div class="small text-muted">Março 2018</div>
                </div>
                <!--/.col-->
                <div class="col-sm-7 d-none d-md-block">
                  ...
                  <div class="btn-group btn-group-toggle float-right mr-3" data-toggle="buttons">
                    <label class="btn btn-outline-secondary">
                      <input type="radio" name="options" id="option1" autocomplete="off"> Dia
                    </label>
                    <label class="btn btn-outline-secondary active">
                      <input type="radio" name="options" id="option2" autocomplete="off" checked=""> Mês
                    </label>
                    <label class="btn btn-outline-secondary">
                      <input type="radio" name="options" id="option3" autocomplete="off"> Ano
                    </label>
                  </div>
                </div>
                <!--/.col-->
            ...
            <div class="card-footer">
              <ul>
                <li>
                  <div class="text-muted">Vendas com Cupons</div>
                ...
                <li class="d-none d-md-table-cell">
                  ...
                  <strong>24.093 Pedidos (40%)</strong>
                  <div class="progress progress-xs mt-2">
                    <div class="progress-bar bg-info" role="progressbar" style="width: 40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </li>
                <li>
                  <div class="text-muted">Cartão de Crédito</div>
                  <strong>78.706 Pedidos (60%)</strong>
                  <div class="progress progress-xs mt-2">
                    <div class="progress-bar bg-warning" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </li>
                <li class="d-none d-md-table-cell">
                  <div class="text-muted">Clientes Novos</div>
                  <strong>22.123 Users (79.85%)</strong>
                  <div class="progress progress-xs mt-2">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </li>
                <li class="d-none d-md-table-cell">
                  <div class="text-muted">Clientes Antigos</div>
                  <strong>20.15%</strong>
                  <div class="progress progress-xs mt-2">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="callout callout-danger">
                            <small class="text-muted">Clientes Antigos</small>
                            <br>
                    ...
                    <div class="col-sm-6 col-lg-4">
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="callout callout-success">
                            <small class="text-muted">Compra Concluída</small>
                            <br>
                      ...
                      <ul class="horizontal-bars type-2">
                        ...
                        <li>
                          ...
                          <span class="title">Mulheres</span>
                        ...
                        <li>
                          ...
                          <span class="title">I'm Hungry APP</span>
